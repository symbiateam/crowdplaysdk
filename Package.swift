...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/symbiateam/crowdplaysdk/releases/download/0.3.4/CrowdPlaySDKCore.xcframework.zip",
            checksum: "7429af78ee657dead013dc74e7fd5cce1f2ed74ad22828c013fa72ea5abefede"
        ),
        .target(
            name: "CrowdPlaySDK",
            dependencies: [
