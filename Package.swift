...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/symbiateam/crowdplaysdk/releases/download/0.3.3/CrowdPlaySDKCore.xcframework.zip",
            checksum: "9779989c8640c7a5dc1d6fe2b1498a27f3e4f8bd680744495b5bac908589539a"
        ),
        .target(
            name: "CrowdPlaySDK",
            dependencies: [
