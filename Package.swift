...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/symbiateam/crowdplaysdk/releases/download/0.3.2/CrowdPlaySDKCore.xcframework.zip",
            checksum: "550fe5547e0f999a583a34b5ec689b14f75e404cc379434b020099bbb14ba141"
        ),
        .target(
            name: "CrowdPlaySDK",
            dependencies: [
